    ...
    <div className="flex min-h-full flex-col">
      ...
      <main id="top" className="flex-1">
        ...
        <section className="relative min-h-[100svh] overflow-hidden hero-atmosphere">
          ...
          <div className="pointer-events-none absolute inset-y-0 right-0 w-full md:w-[62%]" aria-hidden>
            <div className="h-full w-full translate-y-8 opacity-95 md:translate-y-0">
              <BimHeroVisual />
            </div>
          </div>

          <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-6xl flex-col justify-end px-6 pb-16 pt-28 md:justify-center md:px-8 md:pb-24 md:pt-24">
            <div className="max-w-xl">
              <p className="animate-rise font-heading text-4xl leading-none tracking-[0.14em] text-ink sm:text-5xl md:text-6xl lg:text-7xl">
                КОНТУР
              </p>
              <h1
                className="animate-rise mt-6 max-w-lg font-heading text-2xl leading-tight text-ink sm:text-3xl md:text-4xl"
                style={{ animationDelay: "0.12s" }}
              >
                Цифровой контур ваших объектов
              </h1>
              <p
                className="animate-rise mt-5 max-w-md text-base leading-relaxed text-steel md:text-lg"
                style={{ animationDelay: "0.22s" }}
              >
                Ведение BIM-моделей, проектная документация и внедрение процессов в структуру организаций.
              </p>
              <div className="animate-rise mt-8 flex flex-wrap gap-3" style={{ animationDelay: "0.32s" }}>
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="h-11 border-steel/40 bg-white/50 px-6 text-base backdrop-blur-sm"
                >
                  Смотреть услуги
                </Button>
              </div>
        ...
        {/* Services — one purpose, editorial rows, not a card grid */}
        <section id="services" className="border-t border-border bg-[#f7f9fb]">
          <div className="mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            ...
            <p className="mt-4 max-w-xl text-steel">
              Работаем там, где модель должна оставаться живой, документация — согласованной, а процесс — частью компании.
            </p>
        ...
        <section id="approach" className="relative overflow-hidden border-t border-border bg-ink text-[#e8eef3]">
          ...
          <div className="relative mx-auto max-w-6xl px-6 py-20 md:px-8 md:py-28">
            ...
            <p className="mt-4 max-w-xl text-[#a8b6c4]">
              Не продаём «внедрение ради внедрения» — выстраиваем контур, в котором модель, люди и документы говорят на одном языке.
            </p>
            ...
            <ol className="mt-14 grid gap-10 md:grid-cols-3 md:gap-8">
              {steps.map((step, index) => (
                <li key={step.title} className="relative">
                  ...
                  <p className="mt-3 text-[#a8b6c4] leading-relaxed">{step.text}</p>
                </li>
              ))}
            </ol>
          </div>
        ...
        <section id="contact" className="border-t border-border bg-[#f7f9fb]">
          <div className="mx-auto grid max-w-6xl gap-12 px-6 py-20 md:grid-cols-[1fr_1.1fr] md:gap-16 md:px-8 md:py-28">
            <div>
              ...
              <p className="mt-4 max-w-md text-steel leading-relaxed">
                Опишите объект, стадию и задачу — вернёмся с предложением по ведению модели, документации или внедрению BIM.
              </p>
